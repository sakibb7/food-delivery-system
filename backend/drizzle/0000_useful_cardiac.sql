...
CREATE TYPE "public"."cod_remittance_status" AS ENUM('pending', 'remitted', 'confirmed');--> statement-breakpoint
...
CREATE TABLE "orders" (
	...
	"restaurant_earnings" numeric(10, 2) DEFAULT '0' NOT NULL,
...
CREATE TABLE "cod_remittances" (
	...
	"amount_to_remit" numeric(10, 2) NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "cod_remittances_order_id_unique" UNIQUE("order_id")
);
--> statement-breakpoint
...
ALTER TABLE "rider_reviews" ADD CONSTRAINT "rider_reviews_rider_id_users_id_fk" FOREIGN KEY ("rider_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "withdrawal_requests" ADD CONSTRAINT "withdrawal_requests_rider_id_users_id_fk" FOREIGN KEY ("rider_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cod_remittances" ADD CONSTRAINT "cod_remittances_rider_id_users_id_fk" FOREIGN KEY ("rider_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cod_remittances" ADD CONSTRAINT "cod_remittances_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "restaurant_payouts" ADD CONSTRAINT "restaurant_payouts_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;