...
import { updateProfileSchema, updatePasswordSchema } from "../schema/user.schemas.js";
import { updateProfile, changePassword, getAllUsers, toggleBanUser, getUserDetailsForAdmin } from "../services/user.services.js";
import { getMyProfile } from "../services/auth.services.js";
...
export const adminGetUserDetailsHandler = catchErrors(async (req, res) => {
  const userId = Number(req.params.id);
  appAssert(userId, 400, "User ID is required");
