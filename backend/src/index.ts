...
import { NODE_ENV, PORT, CLIENT_WEB_APP_URL, ADMIN_DASHBOARD_URL } from "./constants/env.js";
...
app.use(
  cors({
    origin: [ADMIN_DASHBOARD_URL, CLIENT_WEB_APP_URL],
    credentials: true,
  }),
);
