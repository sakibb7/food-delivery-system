...
export default function NotificationsScreen() {
  ...
  const demoNotifications = [
    { id: '1', title: 'Payment Successful', desc: `Your weekly payout of ${currencySymbol}340.00 has been transferred to your bank account.`, time: '2 hours ago', icon: 'cash-outline', color: '#10b981', bg: '#ecfdf5' },
    { id: '2', title: 'High Demand Alert', desc: `Demand is high in downtown! Go online now to earn an extra ${currencySymbol}2 per delivery.`, time: '5 hours ago', icon: 'trending-up-outline', color: '#f59e0b', bg: '#fffbeb' },
