...
import people1 from "@/../public/people/people1.jpg"
import people2 from "@/../public/people/people2.jpg"
import people3 from "@/../public/people/people3.jpg"
import people4 from "@/../public/people/people4.jpg"

export default function AppDownloadSection() {
  return (
    <section className="py-20 px-6 lg:px-12 max-w-7xl mx-auto w-full overflow-hidden">
      <div className="bg-linear-to-br from-red-600 to-red-700 rounded-[3rem] p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center gap-12">
        {/* Decorative Circles */}
            ...
            <div className="flex -space-x-3">
              {[people1, people2, people3, people4].map((img, i) => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-white/20 bg-gray-200 overflow-hidden">
                  <Image src={img} alt="User" width={40} height={40} className="object-cover" />
                </div>
              ))}
            </div>
