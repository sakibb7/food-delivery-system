...
export default function AddMenuItemModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-red-600 to-red-500 px-8 py-7 text-white relative overflow-hidden shrink-0">
        ...
        >
          ...
          <div>
            ...
            <div
              ...
              className={`w-full h-40 border-2 border-dashed rounded-xl flex flex-col items-center justify-center cursor-pointer transition-colors relative overflow-hidden ${imageUrl ? "border-gray-200" : "border-gray-300 hover:border-red-500 hover:bg-red-50"
                }`}
            >
              {uploadingImage ? (
          ...
          <div className="flex items-center justify-between bg-gray-50 rounded-xl p-4 border border-gray-200">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div
                className={`w-12 h-7 rounded-full transition-colors duration-300 after:content-[''] after:absolute after:top-0.5 after:start-[3px] after:bg-white after:rounded-full after:h-6 after:w-6 after:transition-all after:duration-300 after:shadow-sm ${watchIsAvailable
