      ...
      <nav className="absolute top-0 w-full z-50 flex items-center justify-between px-6 py-4 lg:px-12 bg-black/30 backdrop-blur-md shadow-sm transition-all text-white">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            ...
            className="border-white/20 hover:bg-white/10 text-white px-6 py-2.5 rounded-full font-bold transition-transform hover:scale-105 active:scale-95"
          >
            Sign In
          </Link>
        </div>
      ...
      <section className="bg-red-600 py-24 px-6 lg:px-12 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/restaurant/sign-up" className="bg-white text-red-600 font-extrabold text-lg py-4 px-10 rounded-full transition-all hover:scale-105 active:scale-95 hover:shadow-2xl shadow-lg flex items-center gap-2">
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 px-6 lg:px-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 text-sm font-medium">
            <Link href="/restaurant/sign-in" className="hover:text-white transition-colors">Sign In</Link>
            <Link href="/restaurant/sign-up" className="hover:text-white transition-colors">Sign Up</Link>
