    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <main className="flex-1 py-16 px-6 lg:px-12 max-w-4xl mx-auto w-full">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6 text-gray-700 leading-relaxed">
          ...
          <p>
            Welcome to Tomato! These Terms and Conditions outline the rules and regulations for the use of 
            Tomato's Website and Mobile Application.
          </p>
          
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Acceptance of Terms</h2>
          <p>
            By accessing this application, we assume you accept these terms and conditions in full. 
            Do not continue to use Tomato's application if you do not accept all of the terms and conditions 
            stated on this page.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Services Description</h2>
          <p>
            Tomato provides a platform for users to discover, order, and pay for food from participating restaurants. 
            Tomato acts as an intermediary between you and the restaurant. We do not prepare the food and are not 
          ...
          <p>
            In no event shall Tomato, nor any of its officers, directors, and employees, be liable to you for 
