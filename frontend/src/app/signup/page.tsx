  ...
  return (
    <div className="min-h-screen bg-white flex font-sans">
      ...
      <div className="w-full lg:w-1/2 flex flex-col px-8 sm:px-16 lg:px-24 xl:px-36 py-12 justify-center relative">
        ...
        <Link
          href="/"
          className="absolute top-8 left-8 sm:left-16 lg:left-24 xl:left-36 flex items-center gap-2 group z-10 w-fit"
        >
          <div className="bg-red-600 group-hover:bg-red-700 text-white p-2 rounded-xl font-bold text-xl tracking-tight transition-colors">
            T
          </div>
        ...
        <div className="absolute inset-0 m-4 rounded-[2.5rem] overflow-hidden">
          ...
          <div className="absolute bottom-16 left-16 right-16 z-20 text-white">
            ...
            <p className="text-lg text-gray-300 font-medium">
              Get exclusive access to the best restaurants in town, track your
              orders in real-time, and earn rewards points with every meal.
            </p>
