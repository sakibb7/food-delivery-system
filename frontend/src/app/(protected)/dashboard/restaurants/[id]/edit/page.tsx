...
export default function EditRestaurantPage() {
  ...
  const { data: fetchResult, isLoading: isFetching } = useGetQuery({
    url: `/restaurant/my-restaurants/${restaurantId}`,
  });
  
  const restaurant = fetchResult?.restaurant;
      ...
      <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden">
        <div className="bg-red-600 px-8 py-10 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-6">
            ...
            <div>
              <h1 className="text-3xl font-extrabold tracking-tight">Edit Restaurant</h1>
              <p className="text-red-100 font-medium">Update your restaurant's details.</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={onSubmit} className="p-8 lg:p-12 space-y-10">
          ...
          <div className="pt-6">
            ...
            <p className="text-center text-gray-400 mt-6 text-sm font-medium">
              By adding a restaurant, you agree to our <Link href="/terms" className="text-red-600 hover:underline">Partner Terms of Service</Link>.
            </p>
          </div>
        </form>
      </div>
