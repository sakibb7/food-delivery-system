...
export default function RestaurantDetailsPage() {
  ...
  const { data: restaurantData, isLoading: isLoadingRestaurant, refetch } = useGetQuery({
    url: `/restaurant/my-restaurants/${restaurantId}`,
  });
  ...
  const { mutate: updateRestaurant, isLoading: isToggling } = useQueryMutation({
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-sans">
      ...
      <div className="flex items-center justify-between mb-8">
        <Link
          ...
          className="inline-flex items-center gap-2 text-gray-500 hover:text-red-600 font-bold transition-colors group"
        >
          <ArrowLeft
            size={20}
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={isToggling}
            className={`inline-flex items-center gap-2 font-bold px-4 py-2 rounded-xl transition-colors disabled:opacity-50 ${
              restaurant.isOpen 
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 text-red-600 hover:text-red-700 font-bold bg-red-50 hover:bg-red-100 px-4 py-2 rounded-xl transition-colors"
          >
            <Edit2 size={18} />
            Edit Restaurant
          </Link>
                        ...
                        <div className="mt-auto flex items-center justify-between pt-3">
                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            <button
                              ...
                              className="p-2 hover:bg-red-50 rounded-xl transition-colors cursor-pointer disabled:opacity-50"
                              title="Delete"
