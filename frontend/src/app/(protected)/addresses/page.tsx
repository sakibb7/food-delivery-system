...
// Dynamically import the map picker to avoid SSR issues with Google Maps
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {addresses.map((addr) => {
            ...
            return (
              <div
                key={addr.id}
                className={`bg-white rounded-3xl p-6 shadow-sm border transition-all hover:shadow-md ${addr.isDefault
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${addr.isDefault
                  ...
                  {LABEL_OPTIONS.map((opt) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 font-semibold text-sm transition-all ${isSelected
