      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 font-medium text-sm">
            Placed on Oct 14, 2026 at 1:30 PM
          </p>
        </div>
        <span
          className={`ml-auto px-4 py-1.5 rounded-full text-sm font-bold ${isDelivered ? "bg-green-100 text-green-700" : "bg-blue-100 text-blue-700"}`}
        >
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="pt-6 mt-2 border-t border-dashed border-gray-200">
              ...
              <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                ...
                <span className="font-extrabold text-2xl text-red-600 font-mono">
                  $23.50
                </span>
              </div>
            </div>
