            ...
            >
              <div className="relative h-56 overflow-hidden bg-gray-100">
                ...
                <button 
                  ...
                  className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm w-10 h-10 rounded-full flex items-center justify-center text-red-500 shadow-sm hover:bg-white transition-colors"
                >
