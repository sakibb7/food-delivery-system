...
import { ArrowLeft, MapPin, CreditCard, Clock, ChevronRight, Plus, Trash2 } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full font-sans">
      <div className="flex items-center gap-4 mb-8 border-b border-gray-100 pb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 font-medium text-sm mt-1">Pizza Hut &bull; 2 items</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="text-red-600 font-semibold text-sm hover:text-red-700">Change</button>
            </div>
            ...
            <div className="flex gap-4 p-4 border-2 border-red-500 rounded-2xl bg-red-50 relative overflow-hidden">
               ...
               <div>
                 ...
                 <p className="text-gray-600 text-sm leading-relaxed">
                   123 Main Street, Apt 4B<br />Dhaka, Bangladesh, 1205
                 </p>
                 <p className="text-gray-500 text-sm mt-2 flex items-center gap-2">
                   Phone: <span className="font-medium text-gray-700">+880 1712 345678</span>
                 </p>
               </div>
            </div>
          ...
          {/* Delivery Time */}
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Delivery Time</h2>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
             <div className="flex justify-between items-center mb-6">
              ...
              <button className="text-red-600 font-semibold text-sm hover:text-red-700">Add New</button>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border-2 border-red-500 bg-red-50 rounded-2xl cursor-pointer">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-8 bg-black rounded flex justify-center items-center text-white font-bold text-xs italic">VISA</div>
                  <div>
              ...
              <div className="flex items-center justify-between p-4 border border-gray-200 hover:border-gray-300 rounded-2xl cursor-pointer transition-colors">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-8 bg-green-500 rounded flex justify-center items-center text-white font-bold text-xs text-center leading-tight">Cash</div>
                  <div>
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden sticky top-24">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  <div className="w-16 h-16 bg-gray-100 rounded-xl overflow-hidden relative flex-shrink-0">
                    <Image src="/pizza.png" alt="Pizza" fill className="object-cover" />
                  </div>
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <h4 className="font-bold text-gray-900 leading-tight">Large Pepperoni Pizza</h4>
                      <span className="font-bold text-gray-900">$18.50</span>
                    </div>
                    <p className="text-sm text-gray-500 mt-1">Extra cheese, Thin crust</p>
                    <div className="flex items-center justify-between mt-3">
                      <div className="flex items-center gap-3">
                        <button className="w-8 h-8 rounded-full border border-gray-200 flex justify-center items-center text-gray-600 hover:bg-gray-50">-</button>
                ...
                <div className="flex gap-4">
                  <div className="w-16 h-16 bg-gray-100 rounded-xl overflow-hidden relative flex-shrink-0">
                    <Image src="/burger.png" alt="Burger" fill className="object-cover" />
                  </div>
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <h4 className="font-bold text-gray-900 leading-tight">Coke (Medium)</h4>
              ...
              <div className="pt-6 border-t border-gray-100">
                <div className="flex gap-2">
                  <input type="text" placeholder="Promo Code" className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-500 focus:bg-white transition-colors" />
                  <button className="px-6 py-3 bg-gray-900 hover:bg-black text-white font-bold rounded-xl transition-colors">Apply</button>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-gray-100 space-y-3">
                <div className="flex justify-between text-gray-600">
                  <span>Subtotal</span>
                  <span className="font-medium text-gray-900 font-mono">$24.50</span>
                </div>
                <div className="flex justify-between text-gray-600">
                  <span>Delivery Fee</span>
                  <span className="font-medium text-gray-900 font-mono">$2.00</span>
                </div>
                <div className="flex justify-between text-gray-600">
                  <span>Taxes</span>
                  <span className="font-medium text-gray-900 font-mono">$1.50</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900 p-6 text-white">
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="font-extrabold text-2xl font-mono">$28.00</span>
              </div>
