...
import { getQueryClient, resetQueryClient } from "@/configs/query-client";
                  ...
                  <div className="space-y-4">
                    {savedAddresses.map((addr) => {
                      ...
                      return (
                        ...
                        >
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${addr.isDefault ? "bg-red-100 text-red-600" : "bg-gray-200 text-gray-600"
                            }`}>
                            <AddrIcon size={20} />
                          </div>
