...
export default function RestaurantDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      {/* Hero / Cover */}
      <div className="relative h-64 md:h-80 bg-linear-to-br from-gray-900 to-gray-800 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
          <div className="max-w-5xl mx-auto flex items-end gap-5">
            {restaurant.logo ? (
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-white shadow-xl overflow-hidden shrink-0 border-4 border-white">
                <Image
                  src={restaurant.logo}
                  alt={restaurant.name}
                  width={96}
              ...
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-white shadow-xl shrink-0 border-4 border-white flex items-center justify-center">
                  ...
                  <div className="flex lg:flex-col gap-2 overflow-x-auto no-scrollbar pb-2 lg:pb-0">
                    {categories.map((cat) => (
                      <button
                        ...
                        className={`whitespace-nowrap px-4 py-2 rounded-xl text-sm font-semibold transition-all ${activeCategory === cat
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {groupedMenu[cat].map((item) => {
                      ...
                      return (
                        <div
                          key={item.id}
                          className={`bg-white rounded-2xl border border-gray-100 p-4 flex gap-4 hover:shadow-lg transition-all group ${isUnavailable ? "opacity-50" : ""
                            }`}
                        >
                          {/* Item Image */}
                          {item.image ? (
                            ...
                            <div className="w-24 h-24 rounded-xl bg-linear-to-br from-red-50 to-orange-50 shrink-0 flex items-center justify-center">
                              <UtensilsCrossed
                                size={28}
