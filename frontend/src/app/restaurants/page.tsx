  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <nav className="sticky top-0 w-full z-50 flex items-center justify-between px-6 py-4 lg:px-12 bg-white border-b border-gray-100 shadow-sm transition-all text-gray-900">
        ...
        <div className="hidden md:flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-full border border-gray-100 text-sm font-medium text-gray-600 cursor-pointer hover:bg-gray-100 transition-all">
          <MapPin size={16} className="text-red-500" />
          <span>Ywca Camp, Dhaka</span>
          <div className="w-1 h-1 rounded-full bg-gray-300"></div>
          <span className="text-gray-400">Change</span>
        </div>

        <div className="flex items-center gap-4">
          <button className="hidden sm:flex items-center gap-2 font-medium hover:text-red-600 transition-colors">
            <User size={20} />
            Log in
          </button>
