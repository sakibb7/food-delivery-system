      ...
      <div className="max-w-md w-full mx-auto sm:mx-0 mt-16 lg:mt-0">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="flex justify-between items-center gap-1 ">
            ...
            >
              <input type="checkbox" className="hidden peer" id="user-remember" checked={termsAccept} onChange={() => { }} />
              ...
              <p className="text-sm text-gray-600 font-medium group-hover:text-gray-900 transition-colors">Remember me</p>
            </div>
            <Link
