    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/60 to-gray-50 z-10" />
          <Image
            src="/hero-bg.png"
      ...
      <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto w-full bg-white rounded-3xl shadow-sm mb-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-10 tracking-tight">
          Best Delivery Restaurants in Dhaka
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="group rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-100 bg-white hover:-translate-y-1 cursor-pointer flex flex-col h-full"
            >
        ...
        <div className="mt-10 flex justify-center">
          <Link
            href="/restaurants"
            className="flex items-center gap-2 text-red-600 font-semibold hover:bg-red-50 px-6 py-3 rounded-full transition-colors border border-red-200"
          >
