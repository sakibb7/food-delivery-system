import { Users, Store, FileText, Bike, Loader2 } from "lucide-react";
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{currencySymbol}{stats.totalRevenue}</p>
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg border border-red-100">
              ...
              <Link to="/orders" className="text-sm font-medium text-red-600 hover:text-red-700">Review</Link>
            </div>
