                ...
                >
                  ...
                  <TableCell>
                    <Link to={`/users/${user.id}`} className="flex items-center gap-3">
                      <div className="h-9 w-9 rounded-full bg-gradient-to-br from-orange-100 to-orange-50 flex items-center justify-center text-orange-600 font-semibold text-sm shrink-0">
                        {user.avatar ? (
                          <img
                            src={user.avatar}
                            alt={user.firstName}
            ...
            <div className="p-6">
              ...
              <div className="mt-4 p-3 bg-gray-50 rounded-xl">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-orange-100 to-orange-50 flex items-center justify-center text-orange-600 font-semibold text-sm shrink-0">
