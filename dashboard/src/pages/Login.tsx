...
export default function Login() {
  ...
  const { setUser, isAuth, isInitialized, user, logout } = useContext(AppContext) as AppContextType;
  ...
  useEffect(() => {
    if (isInitialized && isAuth && user) {
      ...
      if (isAdmin) {
        // Prevent redirecting to login page to avoid infinite loop
  ...
  }, [isInitialized, isAuth, user, navigate, redirectUrl, logout]);
